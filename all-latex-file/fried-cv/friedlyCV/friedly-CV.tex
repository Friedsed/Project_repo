	...
	\begin{paracol}{2}
		...
		\begin{leftcolumn}
			...
			\cvsection{COMPÉTENCES}
				...
				\cvskill{Ansys} {} {0.6} \\[-2pt]
				
				\cvskill{3DEXPERIENCE} {} {0.5} \\[-2pt]
				
				\cvskill{Ansys/Abaqus} {} {0.3} \\[-2pt]
		...
		\fcolorbox{white}{maincol}{\begin{minipage}[c][2cm][c]{1\mpwidth}
			...
			\cvsection{PROFIL}
				...
				\cvtext{Étudiant en L3 Mécanique Énergétique, je suis à la recherche d’une alternance en simulation numérique à partir de septembre 2026.
					Je souhaite approfondir mes compétences en modélisation et en simulation tout en mettant en pratique les notions théoriques acquises au cours de ma formation.
				}
			...
			\cvsection{FORMATIONS}
				...
				{1ère année du cycle ingénieur en génie mécanique}
				{}
				{\cvlist{
			...
			\cvsection{EXPÉRIENCES PROFESSIONNELLES}
				...
				{\cvlist{
						...
						\item Présentation du projet à Silverstone en juillet 2025 devant des jurys internationaux, en tant que rapporteur du groupe
				}}
				\\\\
			\cvevent
				{Sept 2024 - Juin 2025}
				...
				{}
				{\cvlist{
						\item Développement d’un site web interactif dédié à la résolution de problèmes mathématiques
						à l'aide de : HTML, CSS, JavaScript
				}}
			\\\\
			\cvevent
				{Sept 2022 - Mars 2023}
