...
\begin{document}
	...
	\begin{paracol}{2}
		...
		\begin{leftcolumn}
			...
			\cvlist{
				\item \textbf{Sport} : course à pied, basket-ball
		...
		\begin{rightcolumn}
			...
			\fcolorbox{white}{maincol}{\begin{minipage}[c][2cm][c]{1\mpwidth}
					...
					\large{ \textcolor{white} {Recherche de master  } }
					\end {center}
			\end{minipage}} \\[14pt]
			\vspace{-12pt}
			...
			\cvtext{Actuellement étudiant en Licence 3 de Mécanique Énergétique, je souhaite intégrer un Master afin de consolider mon expertise théorique et de perfectionner ma maîtrise des concepts fondamentaux de l'ingénierie mécanique
			}
			...
			{\cvlist{
					...
					\item  Résistance des matériaux,Transfert thermiques, Programmation Python, Calcul scientifique
			}}
			\\\\
			\cvevent
			{Sept 2024 - Juin 2025}
			{INSA Toulouse}        % pas d'espace avant/après
			{1re année du cycle ingénieur en génie mécanique}
			{}
			{\cvlist{
