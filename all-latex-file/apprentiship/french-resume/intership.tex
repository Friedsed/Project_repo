	...
	\begin{paracol}{2}
		...
		\begin{rightcolumn}
			...
			\fcolorbox{white}{maincol}{\begin{minipage}[c][2cm][c]{1\mpwidth}
					...
					\large{ \textcolor{white} {Recherche de stage en simulation numérique  } }
					\end {center}
			\end{minipage}} \\[14pt]
			\vspace{-12pt}
			...
			\cvtext{Étudiant en L3 Mécanique Énergétique, je suis à la recherche d’un stage dans le domaine de la mécanique, en particulier en simulation numérique. Mon objectif est de m’investir au sein d’une équipe afin de contribuer à la recherche et à l’innovation dans le domaine de la mécanique.
			}
