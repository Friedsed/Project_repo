...
\begin{document}
	...
	\begin{paracol}{2}
		...
		\begin{leftcolumn}
			...
			\icontext{MapMarker}{12}{Toulouse }{black}\\[10pt]
			...
			\cvlist{
				...
				\item \textbf{Loisirs créatifs} : couture, bricolage
			}
		...
		\begin{rightcolumn}
			...
			\cvtext{Étudiant en L3 Mécanique Énergétique, je recherche une alternance en calcul mécanique et simulation numérique à partir de septembre 2026. Passionné par la modélisation physique des structures ou des fluides, je souhaite développer mes compétences en simulation éléments finis, analyse mécanique et optimisation des systèmes industriels.
			}
			...
			{Depuis Janvier 2025}
			{ISAE Supaero}
			{TLS'e Racing Division: Powertrain}
			{}
			{\cvlist{
