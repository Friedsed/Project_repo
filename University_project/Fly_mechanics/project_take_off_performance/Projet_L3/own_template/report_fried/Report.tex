...
\usepackage{subcaption} % to run multiple pisture 
\usepackage{multirow}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	\input{acronyms}								% Fichier abréviations					%%%%%%%%%%%%		FAIRE APPEL
	\addcontentsline{toc}{chapter}{Liste des abréviations}	% Ajoute à TOC
	% 3 eme page
...
%		addons.tex for the first page shape design 
