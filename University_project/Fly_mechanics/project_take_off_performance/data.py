...
data9 = {
    ...
    "P":  0,  "T":    54000,  "T0":   54000,  "T1": 0,  "T2": 0,  "efficiency": 0.35, 
    "Vhw":  0,  "Vi":   0, "alpha":    0,   "alpha_0":  0,  "tr":   1, "hoc":  35,    
    "A1":  1.158e-2,  "A2": -5.277e-05, "A3":  9.273e-08,  "A4": -6.21e-11, "n":   35}
...
convert_units(data1, "SI" , "US")
convert_units(data2, "SI" , "US")
convert_units(data3, "SI" , "US")
convert_units(data4, "SI" , "US")
convert_units(data5, "SI" , "US")
convert_units(data6, "SI" , "US")
convert_units(data7, "SI" , "US")
convert_units(data8, "SI" , "US")
convert_units(data9, "SI" , "US")
