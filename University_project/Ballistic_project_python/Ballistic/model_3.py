...
class Model_3:
    """Modèle balistique avec trainée, portance et poussée (ODE)."""
    ...
    def plot_contour(self, alphaC, CdC, param_base, t_end):
        """
        Trace des contours de portée R(alpha, Cd).
        ...
        for i, alphai in enumerate(alphaC):
            for j, Cdj in enumerate(CdC):
                ...
                self.update_param(param_new)  # mettre a jour les parametres du model pour avoir un nouveau model
