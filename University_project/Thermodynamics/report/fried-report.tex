...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\thesisTitle}{Point critique de l’hexafluorure de soufre}
% Titre principal du document (utilisé partout : page titre, PDF metadata...)
\newcommand{\authorName}{Friedly WOLI \\ Dabah MBACKE \\ Thao BOYER \\ Ines ABDERRAHMAE }
...
\newcommand{\timeOfProjectTitle}{Date}
...
\begin{document}
	...
	\input{fried-addons}									% Page titre, résumé, déclarations  					%%%%%%%%%%%%		FAIRE APPEL
