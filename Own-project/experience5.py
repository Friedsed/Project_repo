...
"""
print("")
print("the dictionnary that containe the right solution is ")
...
print("the dictionnary that containe the right solution is ")
for keys, values in dict_Temp_ex.items():
    print(f"{keys} : {values}")
    print("")


#print(f"the dictionnary that containe the right solution is ", dict_Temp)
#print(f"the dictionnary that containe the right solution is ", dict_Temp_ex)
