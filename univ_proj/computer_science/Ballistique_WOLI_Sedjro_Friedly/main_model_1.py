...
if task == 0:
    ...
    model = Model_1(h=20, v_0=20, alpha=40)
        

#__________________________________________________________________________________________________
    impact_values = model.set_impact_values()
    model.set_trajectory(impact_values["t_i"],npt)     # reponse à la question 9.2)2 

#__________________________________________________________________________________________________
   # figure1
    model.plot_component()                  # reponse à la question 9.2)3
...
if task==1:
    ...
    model = Model_1(h=20, v_0=20, alpha=40)
    alphas = np.arange(20, 71, 5)  # Angles de 20 A  70 par pas de 5
#_________________________________________________________________________________________________
        # Trajectoires
    trajectoriess=model.set_trajectories(alphas)
#__________________________________________________________________________________________________
    x_list, z_list = trajectoriess[0], trajectoriess[1]  # reponse à la question 10.1)1

#_________________________________________________________________________________________________
        # Trace des trajectoires
    model.plot_trajectories(x_list,z_list,alphas)  # reponse à la question 10.1)2
...
#_________________________________________________________________________________________________
    ...
    print(f"Angle optimal: {optimal_alpha}, Portée maximale: {optimal_distance:.2f} m")
